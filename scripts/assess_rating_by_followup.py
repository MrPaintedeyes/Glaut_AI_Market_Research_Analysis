...
group_0 = df[df['FOLLOWUP'] == 0]['RATING']
group_1 = df[df['FOLLOWUP'] == 1]['RATING']
...
if positive_t_test is True:
  print("The difference in means for the variable "Rating" considering the two levels of the variable FOLLOWUP is statistically significant")
else:
  print("There is not a statistically significant difference between the means of the variable "Rating" considering the two levels of the variable FOLLOWUP")
