...
group_0 = df[df['VOICE'] == str('0')]['Average_Quality_Score']
group_1 = df[df['VOICE'] == str('1')]['Average_Quality_Score']
...
sns.boxplot(x='VOICE', y='Average_Quality_Score', data=df, palette=palette)
plt.title('Average responses quality score per survey by VOICE')
plt.show()
