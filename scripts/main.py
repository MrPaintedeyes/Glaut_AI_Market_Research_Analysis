...
from assess_quality_scores_by_voice import assess_quality_scores_by_voice
from assess_quality_scores_by_followup import assess_quality_scores_by_followup
def main():
    ...
    print("Assessing quality scores by voice...")
    assess_quality_scores_by_voice(data_path)

    print("Assessing quality scores by followup...")
    assess_quality_scores_by_followup(data_path)
